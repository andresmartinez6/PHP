	...
	<?php 
		...
		if(isset($_GET['enviar']))
		{
			...
			|| !$_GET['long'] || !$_GET['accion_d'])
			{
				...
				header("refresh:5;URL=fomulario_animales.php");
			}
			else
			{
				...
				$perrito = new perro($_GET['nombre_p'], $_GET['color_p'], $_GET['fecha_p'], $_GET['raza'], $_GET['sexo']);
				$del = new delfin ($_GET['nombre_d'], $_GET['color_d'], $_GET['fecha_d'], $_GET['long']);
